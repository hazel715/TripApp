...
const defaultEssentials = [
  ...
  { category: "건강 및 상비약", items: ["고산병 약 (홍징톈 등 - 황룡 대비)", "소화제, 진통제, 멀미약"] },
...
const defaultItinerary = [
 ...
 {
    day: 2, date: "4월 18일 (토)", title: "구채구 관광",
    events: [
      { time: "06:10", type: "train", desc: "청두동역-송반역 기차 탑승" },
      { time: "08:10", type: "bus", desc: "송반역-구채구 셔틀버스" },
      { time: "12:00", type: "camera", desc: "구채구 관광" },
      { time: "18:00", type: "hotel", desc: "구채구 Holiday INN 휴식" }
    ]
  },
  {
    day: 3, date: "4월 19일 (일)", title: "청두 관광",
    events: [
      { time: "10:00", type: "bus", desc: "구채구-송반역 셔틀버스" },
      { time: "13:33", type: "train", desc: "송반역-청두동 기차 탑승" },
      { time: "15:30", type: "info", desc: "청두동 도착" },
      { time: "16:00", type: "hotel", desc: "신위안 호텔(Xinyuan) 체크인" }
    ]
  },
  {
